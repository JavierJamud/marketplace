...
const SECTIONS = [
  {
    ...
    body: "Recopilamos los datos que cargás al registrarte (nombre, correo, teléfono, provincia), los datos de tu tienda si sos vendedor (incluyendo documentación de verificación KYC), y los datos de tus pedidos (dirección de entrega, historial de compras). También registramos eventos mínimos de uso (visitas a una tienda, productos agregados al carrito) para mostrarle analíticas básicas a los vendedores.",
  },
  {
  ...
  },
  {
    ...
    body: "Las fotos de identidad y selfie que subís al verificar tu tienda se almacenan cifradas y privadas — nunca se publican ni se comparten con otros usuarios. Solo el equipo de ZeuDin puede revisarlas para aprobar o rechazar tu verificación.",
  },
  {
  ...
  },
  {
    ...
    body: "Podés pedir la corrección o eliminación de tu cuenta y tus datos personales escribiendo desde tu panel. Los pedidos históricos pueden conservarse de forma anonimizada por razones contables, incluso después de eliminar una cuenta.",
  },
  {
