...
export function SuggestionBox() {
  ...
  const submit = useMutation({
    ...
    onSuccess: () => {
      toast.success("¡Gracias! Tu sugerencia llegó al equipo de ZeuDin.");
      setMessage("");
    },
  ...
  return (
    <div className="rounded-lg border border-surface-container-high bg-surface-container-lowest p-6">
      <div className="mb-1 flex items-center gap-2">
        ...
        <div className="text-[15px] font-bold text-on-surface">Sugerencias para ZeuDin</div>
      </div>
      <p className="mb-3.5 text-[12.5px] text-outline">¿Algo que podríamos mejorar? Contanos, lo lee el equipo de ZeuDin.</p>
      <textarea
        value={message}
        onChange={(e) => setMessage(e.target.value)}
        placeholder="Escribí tu idea o mejora acá..."
